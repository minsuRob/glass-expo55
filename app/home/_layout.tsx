                ...
                items: [
                  {
                    ...
                    icon: { name: "info.circle", type: "sfSymbol" },
                  },
                  {
                    type: "action",
                    ...
                    items: [
                      {
                        ...
                        icon: { name: "hand.point.up.left", type: "sfSymbol" },
                      },
                      {
                        type: "action",
                        label: "Due Date",
                      ...
                      },
                      {
                        ...
                        icon: { name: "plus.circle", type: "sfSymbol" },
                      },
                      {
                        type: "action",
                        label: "Priority",
                      ...
                      },
                      {
                        ...
                        icon: { name: "textformat.abc", type: "sfSymbol" },
                      },
                    ],
                  },
                  {
                    type: "submenu",
                    label: "Settings",
                    icon: { name: "gear", type: "sfSymbol" },
                    items: [
                      {
                        type: "action",
                        label: "Notifications",
                        onPress: handleNotifications,
                        icon: { name: "bell", type: "sfSymbol" },
                      },
                      {
                        type: "submenu",
                        label: "Advanced",
                        ...
                        items: [
                          {
                            ...
                            icon: { name: "ladybug", type: "sfSymbol" },
                          },
                          {
                            type: "action",
                  ...
                  },
                  {
                    ...
                    label: "Print",
                    onPress: handlePrint,
                    icon: { name: "printer", type: "sfSymbol" },
                  },
                  {
                    type: "action",
                    label: "Delete List",
